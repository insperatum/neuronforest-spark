...
//      throw new Exception("Did not have enough memory to cache " + rdd + "! Failing.")
  ...
  def getSplitsAndBins(subvolumes: Seq[String], nBaseFeatures:Int, data_root:String, maxBins:Int, baseFeaturesAndOffsets:Seq[(Int, (Int, Int))]) = {
  ...
  def loadData(sc: SparkContext, numExecutors:Int, subvolumes: Seq[String], nBaseFeatures: Int, data_root: String,
               maxBins:Int, baseFeaturesAndOffsets:Seq[(Int, (Int, Int))], proportion: Double,
