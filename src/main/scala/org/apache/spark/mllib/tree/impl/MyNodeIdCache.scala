...
/**
 * :: DeveloperApi ::
 * A given MyTreePoint would belong to a particular node per tree.
 ...
 */
@DeveloperApi
private[tree] class MyNodeIdCache(
...
@DeveloperApi
private[tree] object MyNodeIdCache {
  /**
